...
import { chatWithAdminAI } from "../../services/aiAdminService";
...
export default function AIAssistantAdmin() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "1",
      role: "assistant",
      content: "Halo! Saya **Desaku AI**, asisten pribadi Anda. 🤖\n\nSaya bisa membantu Anda mengecek data warga, melihat statistik desa, atau menjelaskan cara menggunakan fitur aplikasi. \n\n*Coba tanya: \"Cek apakah NIK 1234567890123456 sudah punya akun?\"*",
    },
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      const aiResponse = await chatWithAdminAI(currentInput, historyForAI);
    ...
    >
      <View style={styles.header}>
        ...
        <View style={{ flex: 1, marginLeft: 12 }}>
          <Text style={styles.headerTitle}>Desaku AI Assistant</Text>
          <Text style={styles.headerSubtitle}>Terhubung ke Database Desa</Text>
        </View>
        ...
        ListFooterComponent={
          isLoading ? (
            <View style={styles.typingIndicator}>
              ...
              <Text style={styles.typingText}>Sedang mengecek database...</Text>
            </View>
          ) : null
        }
      />
      ...
      <View style={styles.inputContainer}>
        <TextInput
          style={styles.input}
          placeholder="Tanyakan data warga atau fitur..."
